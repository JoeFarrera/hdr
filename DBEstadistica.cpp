...
{
    46,
    "f:\\netprojects\\tpc_new_vs2008\\dbestadistica.pc"
};


static unsigned int sqlctx = 1764682637;
...
"select ESTADO ,BLOCKTRAFFIC ,BLOCKBUB ,ENCIRCUITO ,MP ,NMP ,DESTINO ,ORDEN ,\
MESA1 ,MESA2  from HISTAGV where REGID=(select max(h1.REGID)  from histagv h1 \
where h1.agv=:b0)           ";
...
226,0,0,8,182,0,9,355,0,0,1,1,0,1,0,1,3,0,0,
245,0,0,8,0,0,13,357,0,0,10,0,0,1,0,2,3,0,0,2,5,0,0,2,5,0,0,2,5,0,0,2,3,0,0,2,
3,0,0,2,3,0,0,2,3,0,0,2,5,0,0,2,5,0,0,
300,0,0,8,0,0,15,369,0,0,0,0,0,1,0,
315,0,0,9,39,0,6,433,0,0,0,0,0,1,0,
330,0,0,10,105,0,5,481,0,0,4,4,0,1,0,1,1,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
361,0,0,11,108,0,3,493,0,0,4,4,0,1,0,1,3,0,0,1,3,0,0,1,3,0,0,1,1,0,0,
392,0,0,12,0,0,29,510,0,0,0,0,0,1,0,
407,0,0,13,131,0,9,563,0,0,3,3,0,1,0,1,3,0,0,1,3,0,0,1,3,0,0,
434,0,0,13,0,0,13,565,0,0,3,0,0,1,0,2,5,0,0,2,5,0,0,2,5,0,0,
461,0,0,13,0,0,15,574,0,0,0,0,0,1,0,
476,0,0,14,36,0,6,593,0,0,0,0,0,1,0,
};
...

{
   ...
   sqlstm.sqptdso = sqlstm.sqtdso;
   sqlcxt(&(*(ptrCtx)), &sqlctx, &sqlstm, &sqlfpn);
   if (sqlca.sqlcode < 0) goto GetLastPositionAGV;
}
...

{
   ...
   sqlstm.sqhstl[0] = (unsigned int  )sizeof(int);
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         void  *)&idbEstado;
   sqlstm.sqinds[0] = (         int  )0;
   sqlstm.sqharm[0] = (unsigned int  )0;
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)dbBlockTraffic;
   sqlstm.sqhstl[1] = (unsigned int  )0;
   sqlstm.sqhsts[1] = (         int  )0;
   sqlstm.sqindv[1] = (         void  *)&idbBlockTraffic;
   sqlstm.sqinds[1] = (         int  )0;
   sqlstm.sqharm[1] = (unsigned int  )0;
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)dbBlockBub;
   sqlstm.sqhstl[2] = (unsigned int  )0;
   sqlstm.sqhsts[2] = (         int  )0;
   sqlstm.sqindv[2] = (         void  *)&idbBlockBub;
   sqlstm.sqinds[2] = (         int  )0;
   sqlstm.sqharm[2] = (unsigned int  )0;
   sqlstm.sqadto[2] = (unsigned short )0;
   sqlstm.sqtdso[2] = (unsigned short )0;
   sqlstm.sqhstv[3] = (         void  *)dbEnCircuito;
   sqlstm.sqhstl[3] = (unsigned int  )0;
   sqlstm.sqhsts[3] = (         int  )0;
   sqlstm.sqindv[3] = (         void  *)&idbEnCircuito;
   sqlstm.sqinds[3] = (         int  )0;
   sqlstm.sqharm[3] = (unsigned int  )0;
   sqlstm.sqadto[3] = (unsigned short )0;
   sqlstm.sqtdso[3] = (unsigned short )0;
   sqlstm.sqhstv[4] = (         void  *)&dbMp;
   sqlstm.sqhstl[4] = (unsigned int  )sizeof(int);
   sqlstm.sqhsts[4] = (         int  )0;
   sqlstm.sqindv[4] = (         void  *)&idbMp;
   sqlstm.sqinds[4] = (         int  )0;
   sqlstm.sqharm[4] = (unsigned int  )0;
   sqlstm.sqadto[4] = (unsigned short )0;
   sqlstm.sqtdso[4] = (unsigned short )0;
   sqlstm.sqhstv[5] = (         void  *)&dbNmp;
   sqlstm.sqhstl[5] = (unsigned int  )sizeof(int);
   sqlstm.sqhsts[5] = (         int  )0;
   sqlstm.sqindv[5] = (         void  *)&idbNmp;
   sqlstm.sqinds[5] = (         int  )0;
   sqlstm.sqharm[5] = (unsigned int  )0;
   sqlstm.sqadto[5] = (unsigned short )0;
   sqlstm.sqtdso[5] = (unsigned short )0;
   sqlstm.sqhstv[6] = (         void  *)&dbDestino;
   sqlstm.sqhstl[6] = (unsigned int  )sizeof(int);
   sqlstm.sqhsts[6] = (         int  )0;
   sqlstm.sqindv[6] = (         void  *)&idbDestino;
   sqlstm.sqinds[6] = (         int  )0;
   sqlstm.sqharm[6] = (unsigned int  )0;
   sqlstm.sqadto[6] = (unsigned short )0;
   sqlstm.sqtdso[6] = (unsigned short )0;
   sqlstm.sqhstv[7] = (         void  *)&dbCodord;
   sqlstm.sqhstl[7] = (unsigned int  )sizeof(int);
   sqlstm.sqhsts[7] = (         int  )0;
   sqlstm.sqindv[7] = (         void  *)&idbCodord;
   sqlstm.sqinds[7] = (         int  )0;
   sqlstm.sqharm[7] = (unsigned int  )0;
   sqlstm.sqadto[7] = (unsigned short )0;
   sqlstm.sqtdso[7] = (unsigned short )0;
   sqlstm.sqhstv[8] = (         void  *)dbMesa1;
   sqlstm.sqhstl[8] = (unsigned int  )0;
   sqlstm.sqhsts[8] = (         int  )0;
   sqlstm.sqindv[8] = (         void  *)&idbMesa1;
   sqlstm.sqinds[8] = (         int  )0;
   sqlstm.sqharm[8] = (unsigned int  )0;
   sqlstm.sqadto[8] = (unsigned short )0;
   sqlstm.sqtdso[8] = (unsigned short )0;
   sqlstm.sqhstv[9] = (         void  *)dbMesa2;
   sqlstm.sqhstl[9] = (unsigned int  )0;
   sqlstm.sqhsts[9] = (         int  )0;
   sqlstm.sqindv[9] = (         void  *)&idbMesa2;
   sqlstm.sqinds[9] = (         int  )0;
   sqlstm.sqharm[9] = (unsigned int  )0;
   sqlstm.sqadto[9] = (unsigned short )0;
   sqlstm.sqtdso[9] = (unsigned short )0;
...

{
   ...
   if (sqlca.sqlcode < 0) goto GetLastPositionAGV;
			...
			MSGTRACE3 ("GetLastPosiciónAGV agv:%d mp:%d nmp:%d", dbMp, dbNmp, ptrAgv->m_id);
			SET_FZ_IN_SYSTEM(*(ptrAgv->m_pFzdat));
			return;

		GetLastPositionAGV:
			MSGERROR1 ("Imposible recuperar última posición para Agv: %d",
				dbNagv);
...

{
 ...
 sqlstm.occurs = (unsigned int  )0;
 sqlcxt(&(*(ptrCtx)), &sqlctx, &sqlstm, &sqlfpn);
 if (sqlca.sqlcode < 0) plsql_error("CDBEstadistica::ArchivarOrdTran-> ",sqlca,oraca);
}
