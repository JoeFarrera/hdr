...
void CAgvClientSocket::HasDataIncoming()
{
	...
	{
		MSGWARNING1 ("CAgvClientSocket::HasDataIncoming: No hay datos por leer.Agv: %d", m_pAgv->m_id);
	}
...
void CAgvClientSocket::DoClose()
{
	...
	{ 
		MSGWARNING1 (_T("CAgvClientSocket::DoClose Agv: %d - INVALID_SOCKET"), m_pAgv->m_id);
		return;
	} 
